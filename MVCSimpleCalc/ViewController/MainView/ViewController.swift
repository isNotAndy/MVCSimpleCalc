...
private extension ViewController {
    ...
    func setupLine1() {
        ...
        let presentButton = createButton(order: 2, title: "%", tag: 17)
        presentButton.addTarget(self, action: #selector(buttonPressed(_:)), for: .touchUpInside)
        presentButton.backgroundColor = AppColors.topButtons
        ...
        line1.addSubview(presentButton)
    ...
    func setupLine4() {
        ...
        let additButton = createButton(order: 3, title: "+", tag: 12)
        additButton.addTarget(self, action: #selector(buttonPressed(_:)), for: .touchUpInside)
        additButton.backgroundColor = AppColors.actions
        additButton.setTitleColor(.black, for: .normal)
        
        line4.addSubview(oneButton)
        line4.addSubview(twoButton)
        line4.addSubview(threeButton)
        line4.addSubview(additButton)
